...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  actor_terms = {
    ...
    "command": ObservationTermCfg(   #环境里有个叫 twist 的 commandobservation 会把这个 twist 取出来喂给 policy
  ...
  rewards = {
    "track_linear_velocity": RewardTermCfg(    #环境随机生成 twist twist 进入 observation policy 输出动作机器人跑起来 reward 根据“真实速度和 twist 的差距”来算
